...
// This function of city list array 
function initList() {
...
//local storage display the current weather forecast 
...
async function displayWeather() {
    ...
    var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=50215f6d7dbe82a6fa5993e31980175e&lat=" + getLat + "&lon=" + getLong;
...
async function displayFiveDayForecast() {
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityname + "&units=imperial&appid=50215f6d7dbe82a6fa5993e31980175e";
    var response = await $.ajax({
        url: queryURL,
        method: "GET"
    })
